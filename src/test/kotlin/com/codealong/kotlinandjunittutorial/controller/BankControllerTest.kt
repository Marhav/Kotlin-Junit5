package com.codealong.kotlinandjunittutorial.controller
...
internal class BankControllerTest @Autowired constructor(
    ...
    inner class PostNewBank {
        ...
        @Test
        fun `should return BAD REQUEST if bank with account number allready exists`() {
            //given
    ...
    inner class PatchExistingBank {
        ...
        fun `should update an existing bank`() {
            //given
            val updatedBank = Bank("1234", 13.0, 70)
    ...
    inner class DeleteExistingBank {
        ...
        @Test
        fun `should return NOT FOUND if no bank with given account number exsist`() {
            //given
